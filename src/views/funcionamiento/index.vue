	...
	<section>
		...
		<div class="contenedorPrincipal">
			...
			<div class="contenedor">
				...
				<!-- <div class="div4" @mouseover="mostrar4=true" @mouseleave="mostrar4=false">
					<transition  name="slide-fade">
						<span class="subtitulo" v-if="!mostrar4">Ventajas</span>
					</transition>
					<transition  name="fade" mode="out-in">
						<div class="parrafos" v-if="mostrar4">
							<p>Si sos profesional independiente o queres comenzar a trabajar por tu cuenta</p>
							<br>
							<p>PROSK fomenta el empleo independiente y/o emprendedurismo, a través de la visualización de las competencias y habilidades de las personas, obteniendo calificaciones y comentarios de los productos o servicios, que validan la calidad de los mismos y el desempeño de su trabajo.</p>
							<br>
							<p>Con PROSK trabajas cuando querés. Vos manejas tus tiempos de acuerdo a tu disponibilidad y acordás con el contratante las condiciones para llevar adelante el servicio o entregar el producto.</p>
						</div>
						<img id="imagen4" src="@/assets/img/i_funcionamiento4.jpg" alt="Funcionalidad" v-if="!mostrar4">
					</transition>
				</div> -->
			</div>
			<div class="ventajas">
...
<script>
import extraerPreguntas from './extraerPreguntas'
import cargarVentajas from './cargarVentajas'
export default {
	name: 'funcionamiento',
	components:{
		preguntas: () => import('./preguntas'),
...
<style scoped>
	...
	/* .div1 { grid-area: 1 / 1 / 2 / 2; background-color: #02173C;}
	.div2 { grid-area: 1 / 2 / 2 / 3; background-color: #560f22;}
	.div3 { grid-area: 1 / 3 / 2 / 4; background-color: #013713;} */
